...
//               height={900}
//               loading="lazy"
//               className="w-full h-auto max-w-[500px] mx-auto object-cover"
//             />
//           </div>
...
//             {/* ⭐ Dynamic Star Ratings with Review Count */}
...
//             <Notification
//               product={{ _id: product._id, name: product.name, quantity: 1, image: product.image}}
...
interface Product {
  ...
  image: string;
  quantity: number;
  reviews: Review[]; // Updated to specific type
}

interface Review {
  rating: number;
  // Add other properties if available in the review
}
