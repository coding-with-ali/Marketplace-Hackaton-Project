...
// // //       })),
// // //       totalPrice: subtotal,
// // //       status: ["pending", "success", "dispatch"],
...
// //         <button className="w-full mt-6 py-3 bg-pink-500 text-white rounded-md hover:bg-pink-600" onClick={handleCheckout} disabled={loading}>
