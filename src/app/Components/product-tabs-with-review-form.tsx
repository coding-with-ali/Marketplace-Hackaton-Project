...
// const ProductTabsWithReviewForm = ({ product }: any) => {
//   const [productData, setProductData] = useState(product); // Updated product data
...
//         </h3>
//         {productData.reviews?.map((r: any, index: number) => (
