...
//       try {
//         // Sanity Query
//         const query = `*[_type == "product"] | order(rand()) [0...4] {
//           _id,
//           name,
//           price,
//           "imageUrl": image.asset->url
//         }`;
//         console.log("Fetching related products..."); // Log before API call
...
//   if (loading) {
//     return <div>Loading related products...</div>; // This will show until the data is fetched
//   }

//   if (products.length === 0) {
//     return <div>No related products found.</div>; // In case no products are fetched
//   }
